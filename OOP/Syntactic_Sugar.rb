#The previous attr methods are a good example of this. The broad name for code or syntax that is a "shortcut" for other code is "Syntactic Sugar".
...
#the data that we put between the brackets will be the first argument, 
#and what comes after the equal sign will be the second argument to our method